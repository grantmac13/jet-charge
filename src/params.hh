...
//  const double nEvents = 50000;       //  NUMBER OF EVENTS  (-1 runs all) //50k for decay production
  const double nEvents = -1;       //  NUMBER OF EVENTS  (-1 runs all) // -1 for data and pythia+geant
  ...
  const double det_jet_ptmin = 15.0;//GeV //detector-level jet pT >= 15 GeV // have been using det-level jet pT >= 5 GeV
